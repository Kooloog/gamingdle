...
function deleteCookie(name) {
    if (getCookie(name)) {
        document.cookie = name +'=; Path=/gamingdle; Expires=Thu, 01 Jan 1970 00:00:01 GMT;';
    }
}
...
function showResults(attempts) {
    ...
    var message = 'Gamingdle ' + daysSinceFirst + ' - ' + (todayAttempts) + "/6<br><br>";
...
document.getElementById("archivebutton").onclick = function () {
    location.href = "https://kooloog.github.io/gamingdle/archive";
};
